...
<xsl:stylesheet version="2.0"
                ...
                xmlns:i18n="https://github.com/ZUGFeRD/quba-viewer/blob/master/doc/xslt-i18n.md"
                xmlns:xr="urn:ce.eu:en16931:2017:xoev-de:kosit:standard:xrechnung-1"
                xmlns:xrv="http://www.example.org/XRechnung-Viewer">
    <!-- Kunden-Material-Nr. und Preiseinzelheiten missing in fr, preiseinzelheiten bg 29-->

    <xsl:param name="language"/>
    <xsl:import href="xrechnung-html.de.xml"/>
    <xsl:variable name="i18n" select="document('xrechnung-html.fr.xliff')"/>
    <xsl:function name="i18n:translate">
        <xsl:param name="key"/>
        <xsl:value-of select="$i18n//*[local-name()='trans-unit' and @id=$key]/*[local-name()='target']/text()"/>
    </xsl:function>
    <!--
    java -jar \Users\jstaerk\workspace\XMLexamples\saxon-he-10.5.jar .\xr.xr xrechnung-html.xsl  language=de >xr.en.html
    -->
    ...
    <xsl:template match="/xr:invoice">
        ...
        <html lang="de">
            <head>
                <meta charset="UTF-8"/>
                <title>
                    <xsl:value-of select="i18n:translate('title')"/>
                </title>
            ...
            <body>
                <form>
                    <div class="menue">
                        <div class="innen">
                            <button type="button" class="tab" id="menueUebersicht" onclick="show(this);">
                                <xsl:value-of select="i18n:translate('overview')"/>
                            </button>
                            <button type="button" class="tab" id="menueDetails" onclick="show(this);">
                                <xsl:value-of select="i18n:translate('items')"/>
                            </button>
                            <button type="button" class="tab" id="menueZusaetze" onclick="show(this)">
                                <xsl:value-of select="i18n:translate('information')"/>
                            </button>
                            <button type="button" class="tab" id="menueAnlagen" onclick="show(this)">
                                <xsl:value-of select="i18n:translate('attachments')"/>
                            </button>
                            <button type="button" class="tab" id="menueLaufzettel" onclick="show(this)">
                                <xsl:value-of select="i18n:translate('history')"/>
                            </button>
                        </div>
                    </div>
                </form>
...
//]]>
    ...
    <xsl:template name="uebersicht">
        <div id="uebersicht" class="divShow">
            <div class="haftungausschluss">
                <xsl:value-of select="i18n:translate('disclaimer')"/>
            </div>
    ...
    <xsl:template name="uebersichtKaeufer" match="xr:BUYER">
        <div id="uebersichtKaeufer" class="box boxZweispaltig">
            <div id="BG-7" title="BG-7" class="boxtitel">
                <xsl:value-of select="i18n:translate('recipientInfo')"/>
            </div>
            <div class="boxtabelle boxinhalt borderSpacing">
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('target')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt44')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt50')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt51')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt163')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt53')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt52')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt54')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt55')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt46')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt46-id')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt56')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt57')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt58')"/>:
                    </div>
    ...
    <xsl:template name="uebersichtVerkaeufer" match="xr:SELLER">
        <div id="uebersichtVerkaeufer" class="box boxZweispaltig">
            <div id="BG-4" title="BG-4" class="boxtitel">
                <xsl:value-of select="i18n:translate('bg4')"/>
            </div>
            <div class="boxtabelle boxinhalt borderSpacing">
                <div class="boxzeile">
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt27')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt35')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt36')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt162')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt38')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt37')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt39')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt40')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt29')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt29-id')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt41')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt42')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt43')"/>:
                    </div>
    ...
    <xsl:template name="uebersichtRechnungsinfo">
        <div class="boxzeile">
            <div id="uebersichtRechnungsinfo" class="box box1v2">
                <div class="boxtitel">
                    <xsl:value-of select="i18n:translate('details')"/>
                </div>
                <div class="boxtabelle boxinhalt">
                    <div class="boxcell boxZweispaltig">
                        <div class="boxtabelle borderSpacing">
                            <div class="boxzeile">
                                <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt1')"/>:
                                </div>
                            ...
                            <div class="boxzeile">
                                <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt2')"/>:
                                </div>
                            ...
                            <div class="boxzeile">
                                <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt3')"/>:
                                </div>
                            ...
                            <div class="boxzeile">
                                <div class="boxdaten legende">
                                    <xsl:value-of select="i18n:translate('bt5')"/>
                                </div>
                        ...
                        <h4><xsl:value-of select="i18n:translate('period')"/>:
                        </h4>
                        <div class="boxtabelle borderSpacing">
                            <div class="boxzeile">
                                <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt73')"/>:
                                </div>
                            ...
                            <div class="boxzeile">
                                <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt74')"/>:
                                </div>
                    ...
                    <div class="boxcell boxZweispaltig">
                        <div class="boxtabelle borderSpacing">
                            <div class="boxzeile">
                                <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt11')"/>:
                                </div>
                            ...
                            <div class="boxzeile">
                                <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt12')"/>:
                                </div>
                            ...
                            <div class="boxzeile">
                                <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt13')"/>:
                                </div>
                            ...
                            <div class="boxzeile">
                                <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt14')"/>:
                                </div>
                        ...
                        <h4><xsl:value-of select="i18n:translate('preceding_invoice_reference')"/>:
                        </h4>
    ...
    <xsl:template match="xr:PRECEDING_INVOICE_REFERENCE">
        <div class="boxtabelle borderSpacing">
            <div class="boxzeile">
                <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt25')"/>:
                </div>
            ...
            <div class="boxzeile">
                <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt26')"/>:
                </div>
    ...
    <xsl:template name="uebersichtRechnungsuebersicht">
        <div class="boxzeile">
            <div id="uebersichtRechnungsuebersicht" class="box">
                <div id="BG-22" title="BG-22" class="boxtitel">
                    <xsl:value-of select="i18n:translate('bg22')"/>
                </div>
                <div class="boxtabelle boxinhalt">
                    <div class="rechnungsZeile">
                        <div class="boxdaten rechnungSp1">
                            <xsl:value-of select="i18n:translate('bt106')"/>
                        </div>
                    ...
                    <div class="rechnungsZeile">
                        <div class="boxdaten rechnungSp1">
                            <xsl:value-of select="i18n:translate('bt107')"/>
                        </div>
                        <div class="boxdaten rechnungSp2 color2">netto</div>
                    ...
                    <div class="rechnungsZeile">
                        <div class="boxdaten rechnungSp1 paddingBottom line1Bottom">
                            <xsl:value-of select="i18n:translate('bt108')"/>
                        </div>
                    ...
                    <div class="rechnungsZeile">
                        <div class="boxdaten rechnungSp1 paddingTop">
                            <xsl:value-of select="i18n:translate('bt109')"/>
                        </div>
                    ...
                    <div class="rechnungsZeile">
                        <div class="boxdaten rechnungSp1">
                            <xsl:value-of select="i18n:translate('bt110')"/>
                        </div>
                    ...
                    <div class="rechnungsZeile">
                        <div class="boxdaten rechnungSp1 paddingBottom line1Bottom">
                            <xsl:value-of select="i18n:translate('bt111')"/>
                        </div>
                    ...
                    <div class="rechnungsZeile">
                        <div class="boxdaten rechnungSp1 paddingTop">
                            <xsl:value-of select="i18n:translate('bt112')"/>
                        </div>
                    ...
                    <div class="rechnungsZeile">
                        <div class="boxdaten rechnungSp1">
                            <xsl:value-of select="i18n:translate('bt113')"/>
                        </div>
                    ...
                    <div class="rechnungsZeile">
                        <div class="boxdaten rechnungSp1 paddingBottom line2Bottom">
                            <xsl:value-of select="i18n:translate('bt114')"/>
                        </div>
                    ...
                    <div class="rechnungsZeile">
                        <div class="boxdaten rechnungSp1 paddingTop bold">
                            <xsl:value-of select="i18n:translate('bt115')"/>
                        </div>
                        <div class="boxdaten rechnungSp2 paddingTop color2">brutto</div>
    ...
    <xsl:template name="uebersichtUmsatzsteuer" match="xr:VAT_BREAKDOWN">
        <div class="boxzeile">
            <div id="uebersichtUmsatzsteuer" class="box">
                <div id="BG-23" title="BG-23" class="boxtitel">
                    <xsl:value-of select="i18n:translate('bg23')"/>
                </div>
                <div class="boxtabelle boxinhalt">
                    <div class="rechnungsZeile">
                        <div class="boxdaten rechnungSp1 bold"><xsl:value-of select="i18n:translate('bt118')"/>:
                    ...
                    <div class="rechnungsZeile">
                        <div class="boxdaten rechnungSp1">
                            <xsl:value-of select="i18n:translate('bt116')"/>
                        </div>
                        <div class="boxdaten rechnungSp2 color2">netto</div>
                        <div id="BT-116" title="BT-116" class="boxdaten rechnungSp3">
                            <xsl:value-of
                                    select="format-number(xr:VAT_category_taxable_amount,'###.##0,00','decimal')"/>
                        </div>
                    </div>
                    <div class="rechnungsZeile">
                        <div class="boxdaten rechnungSp1 line1Bottom">
                            <xsl:value-of select="i18n:translate('bt119')"/>
                        </div>
                        <div class="boxdaten rechnungSp2 color2 line1Bottom"></div>
                        <div id="BT-119" title="BT-119" class="boxdaten rechnungSp3 line1Bottom"><xsl:value-of
                                select="xr:VAT_category_rate"/>%
                        </div>
                    </div>
                    <div class="rechnungsZeile">
                        <div class="boxdaten rechnungSp1">
                            <xsl:value-of select="i18n:translate('bt117')"/>
                        </div>
                        <div class="boxdaten rechnungSp2 color2"></div>
                ...
                <div class="grund">
                    <div><xsl:value-of select="i18n:translate('bt120')"/>:
                        <span id="BT-120" title="BT-120" class="bold">
                            <xsl:value-of select="xr:VAT_exemption_reason_text"/>
                        </span>
                    </div>
                    <div><xsl:value-of select="i18n:translate('bt121')"/>:
    ...
    <xsl:template name="uebersichtNachlass" match="xr:DOCUMENT_LEVEL_ALLOWANCES">
        <div class="boxzeile">
            <div id="uebersichtNachlass" class="box">
                <div id="BG-20" title="BG-20" class="boxtitel">
                    <xsl:value-of select="i18n:translate('bg20')"/>
                </div>
                <div class="boxtabelle boxinhalt">
                    <div class="rechnungsZeile">
                        <div class="boxdaten rechnungSp1 bold"><xsl:value-of select="i18n:translate('bt95')"/>:
                            <span title="BT-95">
                    ...
                    <div class="rechnungsZeile">
                        <div class="boxdaten rechnungSp1">
                            <xsl:value-of select="i18n:translate('bt93')"/>
                        </div>
                        <div class="boxdaten rechnungSp2 color2">netto</div>
                    ...
                    <div class="rechnungsZeile">
                        <div class="boxdaten rechnungSp1 line1Bottom">
                            <xsl:value-of select="i18n:translate('bt94')"/>
                        </div>
                        <div class="boxdaten rechnungSp2 color2 line1Bottom"></div>
                        <div id="BT-94" title="BT-94" class="boxdaten rechnungSp3 line1Bottom"><xsl:value-of
                                select="xr:Document_level_allowance_percentage"/>%
                        </div>
                    </div>
                    <div class="rechnungsZeile">
                        <div class="boxdaten rechnungSp1">
                            <xsl:value-of select="i18n:translate('bt92')"/>
                        </div>
                        <div class="boxdaten rechnungSp2 color2">netto</div>
                    ...
                    <div class="rechnungsZeile">
                        <div class="boxdaten rechnungSp1">
                            <xsl:value-of select="i18n:translate('bt96')"/>
                        </div>
                        <div class="boxdaten rechnungSp2 color2"></div>
    ...
    <xsl:template name="uebersichtZuschlaege" match="xr:DOCUMENT_LEVEL_CHARGES">
        <div class="boxzeile">
            <div id="uebersichtZuschlaege" class="box">
                <div id="BG-21" title="BG-21" class="boxtitel">
                    <xsl:value-of select="i18n:translate('bg21')"/>
                </div>
                <div class="boxtabelle boxinhalt">
                    <div class="rechnungsZeile">
                        <div class="boxdaten rechnungSp1 bold"><xsl:value-of select="i18n:translate('bt102')"/>:
                            <span title="BT-102">
                    ...
                    <div class="rechnungsZeile">
                        <div class="boxdaten rechnungSp1">
                            <xsl:value-of select="i18n:translate('bt100')"/>
                        </div>
                        <div class="boxdaten rechnungSp2 color2">netto</div>
                    ...
                    <div class="rechnungsZeile">
                        <div class="boxdaten rechnungSp1 line1Bottom">
                            <xsl:value-of select="i18n:translate('bt101')"/>
                        </div>
                        <div class="boxdaten rechnungSp2 color2 line1Bottom"></div>
                        <div id="BT-101" title="BT-101" class="boxdaten rechnungSp3 line1Bottom"><xsl:value-of
                                select="xr:Document_level_charge_percentage"/>%
                        </div>
                    </div>
                    <div class="rechnungsZeile">
                        <div class="boxdaten rechnungSp1">
                            <xsl:value-of select="i18n:translate('bt99')"/>
                        </div>
                        <div class="boxdaten rechnungSp2 color2">netto</div>
                        <div id="BT-99" title="BT-99" class="boxdaten rechnungSp3 bold">
                            <xsl:value-of
                                    select="format-number(xr:Document_level_charge_amount,'###.##0,00','decimal')"/>
                        </div>
                    </div>
                    <div class="rechnungsZeile">
                        <div class="boxdaten rechnungSp1">
                            <xsl:value-of select="i18n:translate('bt103')"/>
                        </div>
                        <div class="boxdaten rechnungSp2 color2"></div>
    ...
    <xsl:template name="uebersichtZahlungsinformationen">
        <div id="uebersichtZahlungsinformationen" class="box subBox">
            <div title="" class="boxtitel">
                <xsl:value-of select="i18n:translate('payment')"/>
            </div>
            <div class="boxtabelle boxinhalt borderSpacing">
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt20')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt9')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt81')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt82')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt83')"/>:
                    </div>
    ...
    <xsl:template name="uebersichtCard">
        <div id="uebersichtCard" class="box subBox">
            <div id="BG-18" title="BG-18" class="boxtitel boxtitelSub">
                <xsl:value-of select="i18n:translate('bg18')"/>
            </div>
            <div class="boxtabelle boxinhalt borderSpacing">
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt87')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt88')"/>:
                    </div>
    ...
    <xsl:template name="uebersichtLastschrift">
        <div id="uebersichtLastschrift" class="box subBox">
            <div id="BG-19" title="BG-19" class="boxtitel boxtitelSub">
                <xsl:value-of select="i18n:translate('bg19')"/>
            </div>
            <div class="boxtabelle boxinhalt borderSpacing">
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt89')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt91')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt90')"/>:
                    </div>
    ...
    <xsl:template name="uebersichtUeberweisung">
        <div id="uebersichtUeberweisung" class="box subBox">
            <div id="BG-17" title="BG-17" class="boxtitel boxtitelSub">
                <xsl:value-of select="i18n:translate('bg17')"/>
            </div>
            <xsl:for-each select="xr:PAYMENT_INSTRUCTIONS/xr:CREDIT_TRANSFER">
                <div class="boxtabelle boxinhalt borderSpacing">
                    <div class="boxzeile">
                        <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt85')"/>:
                        </div>
                    ...
                    <div class="boxzeile">
                        <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt84')"/>:
                        </div>
                    ...
                    <div class="boxzeile">
                        <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt86')"/>:
                        </div>
    ...
    <xsl:template name="uebersichtBemerkungen" match="xr:INVOICE_NOTE">
        <div id="uebersichtBemerkungen" class="box">
            <div id="BG-1" title="BG-1" class="boxtitel">
                <xsl:value-of select="i18n:translate('bg1')"/>
            </div>
            <div class="boxtabelle boxinhalt borderSpacing">
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt21')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt22')"/>:
                    </div>
    ...
    <xsl:template match="xr:INVOICE_LINE | xr:SUB_INVOICE_LINE">
            ...
            <div class="boxzeile">
                <div class="box subBox">
                    <div id="BT-126" title="BT-126" class="boxtitel">
                        <xsl:value-of select="i18n:translate('bt126')"/>
                        <xsl:value-of select="xr:Invoice_line_identifier"/>
                    </div>
                    <div class="boxtabelle boxinhalt borderSpacing">
                        <div class="boxzeile">
                            <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt127')"/>:
                            </div>
                        ...
                        <div class="boxzeile">
                            <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt128')"/>:
                            </div>
                        ...
                        <div class="boxzeile">
                            <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt128-id')"/>:
                            </div>
                        ...
                        <div class="boxzeile">
                            <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt132')"/>:
                            </div>
                        ...
                        <div class="boxzeile">
                            <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt133')"/>:
                            </div>
                            <div id="BT-133" title="BT-133" class="boxdaten wert">
                                <xsl:value-of select="xr:Invoice_line_Buyer_accounting_reference"/>
                            </div>
                        </div>
                        <h4 id="BG-26" title="BG-26"><xsl:value-of select="i18n:translate('bg26')"/>:
                        </h4>
                        <div class="boxzeile">
                            <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt134')"/>:
                            </div>
                        ...
                        <div class="boxzeile">
                            <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt135')"/>:
                            </div>
                ...
                <div class="box subBox">
                    <div id="BG-29" title="BG-29" class="boxtitel boxtitelSub">
                        <xsl:value-of select="i18n:translate('bg29')"/>
                    </div>
                    <div class="boxtabelle boxinhalt">
                        <div class="rechnungsZeile">
                            <div class="boxdaten detailSp1 color2">
                                <xsl:value-of select="i18n:translate('bt129')"/>
                            </div>
                        ...
                        <div class="rechnungsZeile">
                            <div class="boxdaten detailSp1 color2">
                                <xsl:value-of select="i18n:translate('bt130')"/>
                            </div>
                        ...
                        <div class="rechnungsZeile">
                            <div class="boxdaten detailSp1 line1Bottom color2">
                                <xsl:value-of select="i18n:translate('bt146')"/>
                            </div>
                        ...
                        <div class="rechnungsZeile">
                            <div class="boxdaten detailSp1 color2">
                                <xsl:value-of select="i18n:translate('bt131')"/>
                            </div>
                            <div id="BT-131" title="BT-131" class="boxdaten detailSp2 bold">
                                <xsl:value-of
                                        select="format-number(xr:Invoice_line_net_amount,'###.##0,00','decimal')"/>
                            </div>
                        </div>
                    </div>
                    <div class="boxtabelle boxinhalt noPaddingTop borderSpacing">
                        <div class="boxzeile">
                            <div class="boxdaten legende "><xsl:value-of select="i18n:translate('bt147')"/>:
                            </div>
                        ...
                        <div class="boxzeile">
                            <div class="boxdaten legende "><xsl:value-of select="i18n:translate('bt148')"/>:
                            </div>
                        ...
                        <div class="boxzeile">
                            <div class="boxdaten legende "><xsl:value-of select="i18n:translate('bt149')"/>:
                            </div>
                        ...
                        <div class="boxzeile">
                            <div class="boxdaten legende "><xsl:value-of select="i18n:translate('bt150')"/>:
                            </div>
                        ...
                        <div class="boxzeile">
                            <div class="boxdaten legende "><xsl:value-of select="i18n:translate('bt151')"/>:
                            </div>
                        ...
                        <div class="boxzeile">
                            <div class="boxdaten legende "><xsl:value-of select="i18n:translate('bt152')"/>:
                            </div>
                            <div id="BT-152" title="BT-152" class="boxdaten wert"><xsl:value-of
        ...
        <div class="boxtabelle">
            <div class="boxzeile">
                <div class="box subBox">
                    <div id="BG-27" title="BG-27" class="boxtitel boxtitelSub">
                        <xsl:value-of select="i18n:translate('bg27')"/>
                    </div>
                    <xsl:for-each select="xr:INVOICE_LINE_ALLOWANCES">
                        <div class="boxtabelle boxinhalt ">
                            <div class="rechnungsZeile">
                                <div class="boxdaten detailSp1 color2">
                                    <xsl:value-of select="i18n:translate('bt137')"/>
                                </div>
                            ...
                            <div class="rechnungsZeile">
                                <div class="boxdaten detailSp1 line1Bottom color2">
                                    <xsl:value-of select="i18n:translate('bt138')"/>
                                </div>
                                <div id="BT-138" title="BT-138" class="boxdaten detailSp2 line1Bottom"><xsl:value-of
                                        select="format-number(xr:Invoice_line_allowance_percentage,'##0,00','decimal')"/>%
                                </div>
                            </div>
                            <div class="rechnungsZeile">
                                <div class="boxdaten detailSp1 color2">
                                    <xsl:value-of select="i18n:translate('bt136')"/>
                                </div>
                        ...
                        <div class="grundDetail">
                            <div class="color2"><xsl:value-of select="i18n:translate('bt139')"/>:
                                <span id="BT-139" title="BT-139" class="bold">
                                    <xsl:value-of select="xr:Invoice_line_allowance_reason"/>
                                </span>
                            </div>
                            <div class="color2"><xsl:value-of select="i18n:translate('bt140')"/>:
                ...
                <div class="box subBox">
                    <div id="BG-28" title="BG-28" class="boxtitel boxtitelSub">
                        <xsl:value-of select="i18n:translate('bg28')"/>
                    </div>
                    <xsl:for-each select="xr:INVOICE_LINE_CHARGES">
                        <div class="boxtabelle boxinhalt ">
                            <div class="rechnungsZeile">
                                <div class="boxdaten detailSp1 color2">
                                    <xsl:value-of select="i18n:translate('bt142')"/>
                                </div>
                            ...
                            <div class="rechnungsZeile">
                                <div class="boxdaten detailSp1 line1Bottom color2">
                                    <xsl:value-of select="i18n:translate('bt143')"/>
                                </div>
                                <div id="BT-143" title="BT-143" class="boxdaten detailSp2 line1Bottom"><xsl:value-of
                                        select="format-number(xr:Invoice_line_charge_percentage,'##0,00','decimal')"/>%
                                </div>
                            </div>
                            <div class="rechnungsZeile">
                                <div class="boxdaten detailSp1 color2">
                                    <xsl:value-of select="i18n:translate('bt141')"/>
                                </div>
                        ...
                        <div class="grundDetail">
                            <div class="color2"><xsl:value-of select="i18n:translate('bt144')"/>:
                                <span id="BT-144" title="BT-144" class="bold">
                                    <xsl:value-of select="xr:Invoice_line_charge_reason"/>
                                </span>
                            </div>
                            <div class="color2"><xsl:value-of select="i18n:translate('bt145')"/>:
        ...
        <div class="boxtabelle">
            <div class="boxzeile">
                <div class="box subBox">
                    <div id="BG-31" title="BG-31" class="boxtitel boxtitelSub">
                        <xsl:value-of select="i18n:translate('bg31')"/>
                    </div>
                    <div class="boxtabelle boxinhalt ">
                        <div class="boxzeile">
                            <div class="boxcell boxZweispaltig">
                                <div class="boxtabelle borderSpacing">
                                    <div class="boxzeile">
                                        <div class="boxdaten legende "><xsl:value-of select="i18n:translate('bt153')"/>:
                                        </div>
                                    ...
                                    <div class="boxzeile">
                                        <div class="boxdaten legende "><xsl:value-of select="i18n:translate('bt154')"/>:
                                        </div>
                                    ...
                                    <div class="boxzeile">
                                        <div class="boxdaten legende "><xsl:value-of select="i18n:translate('bt155')"/>:
                                        </div>
                                    ...
                                    <div class="boxzeile">
                                        <div class="boxdaten legende "><xsl:value-of select="i18n:translate('bt156')"/>:
                                        </div>
                                        <div id="BT-156" title="BT-156" class="boxdaten wert">
                                            <xsl:value-of select="xr:ITEM_INFORMATION/xr:Item_Buyers_identifier"/>
                                        </div>
                                    </div>
                                    <h4 id="BG-32" title="BG-32"><xsl:value-of select="i18n:translate('bg32')"/>:
                                    </h4>
                            ...
                            <div class="boxcell boxZweispaltig">
                                <div class="boxtabelle borderSpacing">
                                    <div class="boxzeile">
                                        <div class="boxdaten legende "><xsl:value-of select="i18n:translate('bt157')"/>:
                                        </div>
                                    ...
                                    <div class="boxzeile">
                                        <div class="boxdaten legende "><xsl:value-of
                                                select="i18n:translate('bt157-id')"/>:
                                        </div>
                                    ...
                                    <div class="boxzeile">
                                        <div class="boxdaten legende "><xsl:value-of select="i18n:translate('bt158')"/>:
                                        </div>
                                        <div id="BT-158" title="BT-158" class="boxdaten wert">
                                            <xsl:value-of
                                                    select="xr:ITEM_INFORMATION/xr:Item_classification_identifier"/>
                                        </div>
                                    </div>
                                    <div class="boxzeile">
                                        <div class="boxdaten legende "><xsl:value-of
                                                select="i18n:translate('bt158-id')"/>:
                                        </div>
                                    ...
                                    <div class="boxzeile">
                                        <div class="boxdaten legende "><xsl:value-of
                                                select="i18n:translate('bt157-vers-id')"/>:
                                        </div>
                                        <div id="BT-158-scheme-version-id" title="BT-158-scheme-version-id"
                                             class="boxdaten wert">
                                            <xsl:value-of
                                    ...
                                    <div class="boxzeile">
                                        <div class="boxdaten legende "><xsl:value-of select="i18n:translate('bt159')"/>:
                                        </div>
    ...
    <xsl:template name="zusaetzeVerkaeufer" match="xr:SELLER" mode="zusaetze">
        <div id="zusaetzeVerkaeufer" class="box boxZweispaltig">
            ...
            <div class="boxtabelle boxinhalt borderSpacing">
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt28')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt34')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt34-id')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt30')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt31')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt32')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt32-schema')"/>:
                    </div>
                    <div id="BT-32-scheme" title="BT-32-scheme" class="boxdaten wert">
                        <xsl:value-of select="xr:Seller_tax_registration_identifier/@scheme_identifier"/>
                    </div>
                </div>
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt33')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt6')"/>:
                    </div>
    ...
    <xsl:template name="zusaetzeSteuervertreter" match="xr:SELLER_TAX_REPRESENTATIVE_PARTY">
        <div id="zusaetzeSteuervertreter" class="box boxZweispaltig">
            <div id="BG-11" title="BG-11" class="boxtitel">
                <xsl:value-of select="i18n:translate('bg11')"/>
            </div>
            <div class="boxtabelle boxinhalt borderSpacing">
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt62')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt64')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt65')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt164')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt67')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt66')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt68')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt69')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt63')"/>:
                    </div>
    ...
    <xsl:template name="zusaetzeKaeufer" match="xr:BUYER" mode="zusaetze">
        <div id="zusaetzeKaeufer" class="box boxZweispaltig">
            <div id="BG-7" title="BG-7" class="boxtitel">
                <xsl:value-of select="i18n:translate('bg7')"/>
            </div>
            <div class="boxtabelle boxinhalt borderSpacing">
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt45')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt49')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt49-id')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt47')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt47-id')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt48')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt7')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt8')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt19')"/>:
                    </div>
    ...
    <xsl:template name="zusaetzeLieferung" match="xr:DELIVERY_INFORMATION">
        <div id="zusaetzeLieferung" class="box boxZweispaltig">
            <div id="BG-13" title="BG-13" class="boxtitel">
                <xsl:value-of select="i18n:translate('bg13')"/>
            </div>
            <div class="boxtabelle boxinhalt borderSpacing">
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt71')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt71-id')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt72')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt70')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt75')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt76')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt165')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt78')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt77')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt79')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt80')"/>:
                    </div>
    ...
    <xsl:template name="zusaetzeVertrag">
        <div id="zusaetzeVertrag" class="box boxZweispaltig">
            <div class="boxtitel">
                <xsl:value-of select="i18n:translate('contract_information')"/>
            </div>
            <div class="boxtabelle boxinhalt borderSpacing">
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt17')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt15')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt16')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt23')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt24')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt18')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt18-id')"/>:
                    </div>
    ...
    <xsl:template name="zusaetzeZahlungsempfaenger" match="xr:PAYEE">
        <div id="zusaetzeZahlungsempfaenger" class="box boxZweispaltig">
            <div id="BG-10" title="BG-10" class="boxtitel">
                <xsl:value-of select="i18n:translate('bg10')"/>
            </div>
            <div class="boxtabelle boxinhalt borderSpacing">
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt59')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt60')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt60-id')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt61')"/>:
                    </div>
                ...
                <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt61-id')"/>:
                    </div>
            ...
            <div class="boxtabelle boxabstandtop">
                <div class="boxzeile">
                    <div id="anlagenListe" class="box">
                        <div id="BG-24" title="BG-24" class="boxtitel">
                            <xsl:value-of select="i18n:translate('bg24')"/>
                        </div>
    ...
    <xsl:template match="xr:ADDITIONAL_SUPPORTING_DOCUMENTS">
        <div class="boxtabelle boxinhalt borderSpacing">
            <div class="boxzeile">
                <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt122')"/>:
                </div>
            ...
            <div class="boxzeile">
                <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt123')"/>:
                </div>
            ...
            <div class="boxzeile">
                <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt124')"/>:
                </div>
            ...
            <div class="boxzeile">
                <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt125')"/>:
                </div>
                <div id="BT-125" title="BT-125" class="boxdaten wert">
                    <a href="#"
                       onClick="downloadData('{xr:Supporting_document_reference}')">Öffnen
                    </a>
                </div>
            ...
            <div class="boxzeile">
                <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt125-format')"/>:
                </div>
                <div id="BT-125" title="BT-125" class="boxdaten wert">
            ...
            <div class="boxzeile">
                <div class="boxdaten legende"><xsl:value-of select="i18n:translate('bt125-name')"/>:
                </div>
                <div id="BT-125" title="BT-125" class="boxdaten wert">
    ...
    <xsl:template match="xrv:laufzettelEintrag">
        <div class="boxtabelle boxinhalt borderSpacing">
            <div class="boxzeile">
                <div class="boxdaten legende">
                    <xsl:value-of select="i18n:translate('historyDate')"/>
                </div>
            ...
            <div class="boxzeile">
                <div class="boxdaten legende"><xsl:value-of select="i18n:translate('historySubject')"/>:
                </div>
                <div class="boxdaten wert">
            ...
            <div class="boxzeile">
                <div class="boxdaten legende"><xsl:value-of select="i18n:translate('historyText')"/>:
                </div>
                <div class="boxdaten wert">
            ...
            <div class="boxzeile">
                <div class="boxdaten legende"><xsl:value-of select="i18n:translate('historyDetails')"/>:
                </div>
                <div class="boxdaten wert">
